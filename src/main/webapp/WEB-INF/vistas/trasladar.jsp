...
<div class="container">
	...
	<p>A continuación se muestran los datos del paciente y sus
		requisitos para preparar su traslado.</p>
	...
	background-color: #555;
			...
			<div class="">
				...
				<c:if test="${paciente.getEsFumador() == true}">
					<label for="" class="h6"> Fumador<c:if
							test="${paciente.getEsFumador() == true}">a
				</c:if>:
					</label>
					<span class="text-danger"> Activ<c:if
							test="${paciente.getEsFumador() == true}">o</c:if>
						<c:if test="${paciente.getEsFumador() == true}">a</c:if>.
					</span>
				</c:if>
			...
			<div class="form-group px-0">
				<p>
					Algunos de los siguientes requisitos para realizar el traslado han
					sido autocompletados en base a la condición del paciente. <br>Puede
			...
			<div class="form-row">
				...
				<div class="form-group col-lg-6 col-md-12">
					<label for="" class="h6 my-3">Motivo del traslado<span
						class="text-primary font-weight-bold">*</span></label> <select
						name="motivoTraslado" class="form-control br-radius-zero" required>
