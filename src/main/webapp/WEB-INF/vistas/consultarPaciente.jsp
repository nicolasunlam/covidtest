...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	...
	<div class="container">
		...
		<div>
			...
			<form:form action="detalle" method="POST" modelAttribute="paciente"
				...
				<div class="form-group">
					...
					<form:input path="numeroDocumento" type="text" name="name"
				...
				<div class="form-group">
					...
					<form:select path="tipoDocumento" name="tipoDocumento"
						type="TipoDocumento" class="form-control br-radius-zero">
						<option path="tipoDocumento" id="tipoDocumento"
							type="TipoDocumento">DNI
						<option path="tipoDocumento" id="tipoDocumento"
							type="TipoDocumento">PASAPORTE
						<option path="tipoDocumento" id="tipoDocumento"
							type="TipoDocumento">LIBRETA CÍVICA
					</form:select>
				...
				<div class="form-action">
					<button type="submit" class="btn btn-sm btn-outline-secondary">Consultar
						Paciente</button>
				</div>
				<br>
				<div class="form-group">
