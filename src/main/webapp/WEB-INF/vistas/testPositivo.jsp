...
<h1 class="text-center mb-3 mt-5">El resultado de su test ha sido
	positivo</h1>
...
<div class="text-center my-5">
	<img src="img/virus.png" class="rounded" alt="virus" width="350"
		height="350">
</div>

<c:if test='${rol != null}'>
	<div class="container my-5">
		<h4 class="text-center mt-3 mb-5">Usted será contactado en la
			brevedad</h4>
	</div>
</c:if>
...
<c:if test='${rol == null}'>
	...
	<div class="container my-5">
		<h3 class="text-center my-3">Complete los siguientes datos y sera
			contactado en la brevedad</h3>
	</div>
			...
			<div class="col-4">
				...
				<div class="card border-dark mb-3">
					...
					<div class="card-body text-dark">
						<form action="detalleRegistroPaciente" method="POST"
							...
							<%--<div class="form-row my-4">
								<div class="form-group col-9">
									<label for="calle">Calle <span
										...
										data-msg="Ingrese número de CUIT valido" required /> <small
										id="calleHelp" class="form-text text-muted">Ingrese la
										calle en donde reside actualmente</small>
								</div>
								<div class="form-group col-3">
									<label for="numero">Número <span
										class="text-primary font-weight-bold">*</span></label> <input
										type="number" name="numero"
										class="form-control br-radius-zero" id="numero"
							...
							<%--<div class="form-row my-4">
								<div class="form-group col-6">
									<label for="nombreLocalidad">Localidad <span
										...
										<option id="Carlos Spegazzini" class="partido12"
											name="Carlos Spegazzini">Carlos Spegazzini
										...
										<option id="Don Torcuato" class="partido4" name="Don Torcuato">Don
											Torcuato
										<option id="El Palomar" class="partido5" name="El Palomar">El
											Palomar
										<option id="General Pacheco" class="partido4"
											name="General Pacheco">General Pacheco
										<option id="Gregorio de Laferrere" class="partido9"
											name="Gregorio de Laferrere">Gregorio de Laferrere
										...
										<option id="Isidro Casanova" class="partido9"
											name="Isidro Casanova">Isidro Casanova
										<option id="José María Ezeiza" class="partido12"
											name="José María Ezeiza">José María Ezeiza
										<option id="La Reja" class="partido8" name="La Reja">La
											Reja
										<option id="La Tablada" class="partido9" name="La Tablada">La
											Tablada
										<option id="Lomas del Mirador" class="partido9"
											name="Lomas del Mirador">Lomas del Mirador
										...
										<option id="Paso del Rey" class="partido8" name="Paso del Rey">Paso
											del Rey
										<option id="San Isidro" class="partido2" name="San Isidro">San
											Isidro
										<option id="San Justo" class="partido9" name="San Justo">San
											Justo
										...
										<option id="Valentín Alsina" class="partido10"
											name="Valentín Alsina">Valentín Alsina
										<option id="Vicente López" class="partido1"
											name="Vicente López">Vicente López
										...
										<option id="Villa Fiorito" class="partido11"
											name="Villa Fiorito">Villa Fiorito
										<option id="Villa Martelli" class="partido1"
											name="Villa Martelli">Villa Martelli
										<option id="Villa Sarmiento" class="partido5"
											name="Villa Sarmiento">Villa Sarmiento
								...
								<div class="form-group col-6">
									<label for="nombrePartido">Partido <span
										...
										<option id="florencioVarelaMunicipio"
											name="florencioVarelaMunicipio">Florencio Varela
										...
										<option id="laMatanzaMunicipio" name="laMatanzaMunicipio">La
											Matanza
										<option id="lomasDeZamoraMunicipio"
											name="lomasDeZamoraMunicipio">Lomas de Zamora
										...
										<option id="sanIsidroMunicipio" name="San Isidro">San
											Isidro
										<option id="sanFernandoMunicipio" name="San Fernando">San
											Fernando
							...
							<div class="form-row my-4">
								...
								<div class="form-group col-6">
									<label for="numeroDocumento">Numero de documento <span
										...
										data-rule="minlen:1" data-msg="Ingrese número de CUIT valido"
										required /> <small id="numeroDocumentoHelp"
										class="form-text text-muted">Sin puntos ni espacios.
										Ej: 30758124</small>
								</div>
							</div>
