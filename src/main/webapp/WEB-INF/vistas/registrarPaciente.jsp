...
<div class="container">
	...
	<div
		...
		<a type="button" class="btn btn-success" href="crearPiso">
			Volver</a>
	</div>
	<h6 class="mb-5">Registre un paciente para poder internarlo luego</h6>


	<form action="registrarPacienteEnfermedades" method="POST"
		modelAttribute="paciente" role="form" class="contactForm">
		...
		<div class="form-group">
			...
			<input type="text" name="nombre" class="form-control br-radius-zero"
				id="nombre" placeholder="Ingrese el nombre del paciente"
				data-rule="minlen:3" data-msg="Ingrese un nombre válido" required />
		...
		<div class="form-group">
			...
			<input type="text" name="email" class="form-control br-radius-zero"
				id="email" placeholder="Ingrese un mail" data-rule="mail"
