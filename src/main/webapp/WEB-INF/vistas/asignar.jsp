...
<div class="container">
	...
	<p>A continuación se muestran los datos del paciente y sus
		requisitos para preparar su asignación.</p>
...
.circulo {
	...
	background-color: #555;
			...
			<div class="form-group px-0">
				<p>
					Algunos de los siguientes requisitos para realizar la asignación
					han sido autocompletados en base a la condición del paciente. <br>Puede
