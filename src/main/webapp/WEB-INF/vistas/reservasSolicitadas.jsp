...
<div class="container">
	...
	<div
		...
		<h2 class="">Reservas Solicitadas</h2>

	</div>
	<h6 class="mb-5">Vea en detalle todas las reservas solicitadas por
		su institución</h6>

	<p class="mt-2 mb-4">opciones para camabiar a reservas para autorizar o para filtrar tabla...</p>
		...
		<table id="myTable"
			...
			<tr class="una bg-white">
				...
				<th style="vertical-align: middle;" class="border border-secondary"
					...
					<br>DE CAMAS <img alt="" src="img/sort.svg" width="1em"
					height="1em">
				...
				<tr
					...
					<form action="enviarSolicitud" method="GET">
						...
						<input type="hidden"
							...
							name="idInstitucionATrasladar"> <input type="hidden"
							value="${motivoTraslado}" name="motivoTraslado"> <input
							type="hidden" value="${urgencia}" name="urgencia"> <input
							type="hidden" value="${Math.round(institucion.getDistancia())}"
							name="distanciaTraslado">
