...
<section class="container">
	...
	<div class="jumbotron mt-5"
		...
		<c:if test='${rol != null}'>
			...
			<p class="">
				<c:if test='${rol == "ADMIN"}'>
					Ir al <a class="text-white" href="admin">panel de control </a> de la institución.
				</c:if>
				<c:if test='${rol == "INSTITUCION"}'>
					Ir al <a class="text-white" href="bienvenido">panel control </a> de la institución.
						</c:if>
				<c:if test='${rol == "PACIENTE"}'>
					Ir a <a class="text-white" href="bienvenidoPaciente">mi perfil.</a>
				</c:if>
			</p>
			...
			<p class="lead mb-0">
				...
				<c:if test='${rol == "INSTITUCION"}'>
					<a class="btn btn-light btn-lg text-primary " role="button"
						href="bienvenido">Panel de control 
				</c:if>
				<c:if test='${rol == "PACIENTE"}'>
					<a class="btn btn-light btn-lg text-primary " role="button"
						href="bienvenidoPaciente">Mi perfil 
				</c:if>
				</a>
			</p>
		</c:if>
